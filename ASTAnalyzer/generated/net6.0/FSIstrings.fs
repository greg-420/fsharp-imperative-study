// This is a generated file; the original input is '.\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt'
...
type internal SR private() =
    ...
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:2)
    static member stoppedDueToError() = (GetStringFunc("stoppedDueToError",",,,") )
    /// Usage: %s <options> [script.fsx [<arguments>]]
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:3)
    static member fsiUsage(a0 : System.String) = (GetStringFunc("fsiUsage",",,,%s,,,") a0)
    /// - INPUT FILES -
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:4)
    static member fsiInputFiles() = (GetStringFunc("fsiInputFiles",",,,") )
    /// - CODE GENERATION -
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:5)
    static member fsiCodeGeneration() = (GetStringFunc("fsiCodeGeneration",",,,") )
    /// - ERRORS AND WARNINGS -
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:6)
    static member fsiErrorsAndWarnings() = (GetStringFunc("fsiErrorsAndWarnings",",,,") )
    /// - LANGUAGE -
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:7)
    static member fsiLanguage() = (GetStringFunc("fsiLanguage",",,,") )
    /// - MISCELLANEOUS -
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:8)
    static member fsiMiscellaneous() = (GetStringFunc("fsiMiscellaneous",",,,") )
    /// - ADVANCED -
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:9)
    static member fsiAdvanced() = (GetStringFunc("fsiAdvanced",",,,") )
    /// Exception raised when starting remoting server.\n%s
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:10)
    ...
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:11)
    static member fsiUse() = (GetStringFunc("fsiUse",",,,") )
    /// #load the given file on startup
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:12)
    ...
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:13)
    static member fsiRemaining() = (GetStringFunc("fsiRemaining",",,,") )
    /// Display this usage message (Short form: -?)
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:14)
    ...
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:15)
    static member fsiExec() = (GetStringFunc("fsiExec",",,,") )
    /// Execute interactions on a Windows Forms event loop (on by default)
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:16)
    static member fsiGui() = (GetStringFunc("fsiGui",",,,") )
    /// Suppress fsi writing to stdout
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:17)
    static member fsiQuiet() = (GetStringFunc("fsiQuiet",",,,") )
    /// Support TAB completion in console (on by default)
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:18)
    static member fsiReadline() = (GetStringFunc("fsiReadline",",,,") )
    /// Emit debug information in quotations
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:19)
    static member fsiEmitDebugInfoInQuotations() = (GetStringFunc("fsiEmitDebugInfoInQuotations",",,,") )
    /// For help type #help;;
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:20)
    ...
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:21)
    static member fsiConsoleProblem() = (GetStringFunc("fsiConsoleProblem",",,,") )
    /// '%s' is not a valid assembly name
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:22)
    static member fsiInvalidAssembly(a0 : System.String) = (2301, GetStringFunc("fsiInvalidAssembly",",,,%s,,,") a0)
    /// Directory '%s' doesn't exist
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:23)
    ...
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:24)
    static member fsiLineTooLong() = (GetStringFunc("fsiLineTooLong",",,,") )
    /// Real: %s, CPU: %s, GC %s
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:25)
    ...
    /// gen
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:26)
    ...
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:27)
    static member fsiExceptionDuringPrettyPrinting(a0 : System.String) = (GetStringFunc("fsiExceptionDuringPrettyPrinting",",,,%s,,,") a0)
    ///   F# Interactive directives:
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:28)
    ...
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:29)
    static member fsiIntroTextHashrInfo() = (GetStringFunc("fsiIntroTextHashrInfo",",,,") )
    /// Add the given search path for referenced DLLs
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:30)
    ...
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:31)
    ...
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:32)
    static member fsiIntroTextHashloadInfo() = (GetStringFunc("fsiIntroTextHashloadInfo",",,,") )
    /// Toggle timing on/off
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:33)
    static member fsiIntroTextHashtimeInfo() = (GetStringFunc("fsiIntroTextHashtimeInfo",",,,") )
    /// Display help
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:34)
    static member fsiIntroTextHashhelpInfo() = (GetStringFunc("fsiIntroTextHashhelpInfo",",,,") )
    /// Exit
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:35)
    static member fsiIntroTextHashquitInfo() = (GetStringFunc("fsiIntroTextHashquitInfo",",,,") )
    /// Clear screen
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:36)
    static member fsiIntroTextHashclearInfo() = (GetStringFunc("fsiIntroTextHashclearInfo",",,,") )
    ///   F# Interactive command line options:
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:37)
    static member fsiIntroTextHeader2commandLine() = (GetStringFunc("fsiIntroTextHeader2commandLine",",,,") )
    ///       See '%s' for options
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:38)
    static member fsiIntroTextHeader3(a0 : System.String) = (GetStringFunc("fsiIntroTextHeader3",",,,%s,,,") a0)
    /// Loading
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:39)
    static member fsiLoadingFilesPrefixText() = (GetStringFunc("fsiLoadingFilesPrefixText",",,,") )
    /// \n- Interrupt\n
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:40)
    static member fsiInterrupt() = (GetStringFunc("fsiInterrupt",",,,") )
    /// \n- Exit...\n
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:41)
    static member fsiExit() = (GetStringFunc("fsiExit",",,,") )
    /// - Aborting main thread...
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:42)
    ...
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:43)
    static member fsiCouldNotInstallCtrlCHandler(a0 : System.String) = (GetStringFunc("fsiCouldNotInstallCtrlCHandler",",,,%s,,,") a0)
    /// --> Referenced '%s'
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:44)
    ...
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:45)
    ...
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:46)
    ...
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:47)
    static member fsiDidAHashI(a0 : System.String) = (GetStringFunc("fsiDidAHashI",",,,%s,,,") a0)
    /// --> Timing now on
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:48)
    static member fsiTurnedTimingOn() = (GetStringFunc("fsiTurnedTimingOn",",,,") )
    /// --> Timing now off
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:49)
    ...
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:50)
    ...
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:51)
    ...
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:52)
    ...
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:53)
    static member fsiProductName(a0 : System.String) = (GetStringFunc("fsiProductName",",,,%s,,,") a0)
    /// F# Interactive for F# %s
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:54)
    ...
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:55)
    ...
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:56)
    ...
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:57)
    static member fsiOperationFailed() = (GetStringFunc("fsiOperationFailed",",,,") )
    /// Emit multiple assemblies (on by default)
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:58)
    ...
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:59)
    ...
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:60)
    ...
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Interactive\FSIstrings.txt:61)
