// This is a generated file; the original input is '.\paket-files\dotnet\fsharp\src\Compiler\Facilities\UtilsStrings.txt'
...
type internal SR private() =
    ...
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Facilities\UtilsStrings.txt:1)
    static member buildProductName(a0 : System.String) = (GetStringFunc("buildProductName",",,,%s,,,") a0)
    /// %s for F# %s
    /// (Originally from .\paket-files\dotnet\fsharp\src\Compiler\Facilities\UtilsStrings.txt:2)
